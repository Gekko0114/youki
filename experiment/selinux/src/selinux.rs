...
impl SELinux {
    ...
    pub fn file_label(fpath: &Path) -> Result<String, SELinuxError> {
        ...
        get_xattr(fpath, XATTR_NAME_SELINUX).map_err(|e| SELinuxError::FileLabel(e.to_string()))
    }
    ...
    pub fn lfile_label(fpath: &Path) -> Result<String, SELinuxError> {
        ...
        lget_xattr(fpath, XATTR_NAME_SELINUX).map_err(|e| SELinuxError::LFileLabel(e.to_string()))
    }
